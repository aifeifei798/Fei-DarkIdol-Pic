style_list = [    
    ...
    {
        "name": "伦勃朗光 (经典人像)",
        "prompt": "{prompt}, Rembrandt lighting, chiaroscuro, dramatic shadows, artistic contrast, studio masterpiece",
        "negative_prompt": ""
    },
    {
        "name": "爱心光斑 (创意)",
    ...
    {
        "name": "柔光箱摄影 (商业大片)",
        "prompt": "{prompt}, soft studio lighting, beauty dish, professional fashion photography, even lighting, flawless skin",
        "negative_prompt": ""
    },
    {
        "name": "赛博霓虹 (夜景)",
